...
class SettingsTableViewController: UITableViewController {
  ...
  let writeReviewIdentifier = "writeReviewCell"
  let shareAppIdentifier = "shareAppIdentifierCell"
  let aboutUsIdentifier = "aboutUsCell"
  
  let appURL = "https://itunes.apple.com/app/id1450365090"
  ...
  override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    case 1:
      ...
      case 1:
        let writeReviewCell = UITableViewCell(style: .default, reuseIdentifier: writeReviewIdentifier)
        writeReviewCell.textLabel?.text = "Write a Review"
        writeReviewCell.accessoryType = .disclosureIndicator
        return writeReviewCell
      case 2:
        let shareAppCell = UITableViewCell(style: .default, reuseIdentifier: shareAppIdentifier)
        shareAppCell.textLabel?.text = "Share this App"
        shareAppCell.accessoryType = .disclosureIndicator
        return shareAppCell
      case 3:
  ...
  private func writeReview(){
    var components = URLComponents(url: URL(string: appURL)!, resolvingAgainstBaseURL: false)
  ...
  private func shareApp() {
    let activityViewController = UIActivityViewController(
      activityItems: [URL(string: appURL)!],
